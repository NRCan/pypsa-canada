...
- Add hook for model-specific constraints
...
- Added old canada model in gitignore
- Added old canada model in gitignore
...
- Idea export feature
- fixing idea export format

## 0.2.1 (2026-05-12)

### Bug Fixes

- Rep days methods fixed
- Add a check for kmedoid vre if no solar or wind
...
- Added a test environment variable for quick testing.
- Temporary removing storage from Canada model example

## 0.0.3 (2026-02-20)

### Maintenance

- Updated precommit file & ruff cleanup
- Updated precommit file & ruff cleanup
