...
rule plot_corridor_map:
    ...
    output:
        ...
        planning_corridor_summary=f"{RUN_OUTPUT_DIR}/planning_corridor_utilization_map_summary.csv",
        dispatch_corridor_summary=f"{RUN_OUTPUT_DIR}/dispatch_corridor_utilization_map_summary.csv"
    log:
