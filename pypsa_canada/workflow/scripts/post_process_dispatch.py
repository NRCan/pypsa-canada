...
# ── Snakemake wiring ──
LOG_PATH = str(snakemake.log[0]) if snakemake.log else "logs/post_process_dispatch.log"
...
solved_dispatch_path = str(snakemake.input.solved_dispatch_network)
output_dir = str(snakemake.output.dispatch_postprocess)
